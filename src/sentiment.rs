...
impl SentimentLexicon {
    const POSITIVE: &'static [&'static str] = &[
        ...
        "love", "happy", "glad", "pleased", "thank", "thanks", "awesome",
        "perfect", "beautiful", "brilliant", "enjoy", "helpful", "nice",
        "excited", "impressive", "outstanding", "superb", "delighted",
    ];

    const NEGATIVE: &'static [&'static str] = &[
        "bad", "terrible", "awful", "horrible", "hate", "angry", "upset",
        "frustrated", "annoyed", "disappointed", "wrong", "broken", "fail",
        "error", "bug", "crash", "slow", "ugly", "confusing", "worst",
        "useless", "stupid", "impossible", "painful", "problem",
    ];

    const TRUST: &'static [&'static str] = &[
        "trust", "reliable", "honest", "safe", "secure", "confident",
        "depend", "faith", "loyal", "sincere",
    ];

    const CURIOSITY: &'static [&'static str] = &[
        "curious", "wonder", "interesting", "how", "why", "explore",
        "learn", "discover", "question", "investigate",
    ];

    const FRUSTRATION: &'static [&'static str] = &[
        "frustrated", "annoyed", "irritated", "stuck", "confused",
        "broken", "doesn't work", "can't", "impossible", "give up",
    ];
}
